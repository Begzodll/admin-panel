...
const Section = styled.section`
  background-image: url('https://images.unsplash.com/photo-1619364726002-dfd4fdaee5f2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')
`

function Home({userGoogle}) {
    return (
        <div>
            {
                userGoogle ? <Section className="h-screen bg-cover">
                    <div className="flex h-full w-full items-center justify-center container mx-auto px-8">
                        <div className="max-w-2xl text-center">
                            <h1 className="text-3xl sm:text-5xl capitalize tracking-widest text-white lg:text-7xl">Comming
                                Soon</h1>

                            <p className="mt-6 lg:text-lg text-white">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa ea iste reiciendis.
                            </p>
...
export default connect(({register: {userGoogle}}) => ({userGoogle}), null)(Home)